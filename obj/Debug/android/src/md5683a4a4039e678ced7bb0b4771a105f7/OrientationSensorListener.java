...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Essentials.OrientationSensorListener, Xamarin.Essentials, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", OrientationSensorListener.class, __md_methods);
	}
	...
	public OrientationSensorListener ()
	{
		...
		if (getClass () == OrientationSensorListener.class)
			mono.android.TypeManager.Activate ("Xamarin.Essentials.OrientationSensorListener, Xamarin.Essentials, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
